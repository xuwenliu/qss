      ...
      <div>
        ...
        <div class="bg0 bt1 bb1" style="margin-top: 0.4rem">
          ...
          <div class="info-input">
            <span>持卡人</span>
            <input disabled="disabled" placeholder="请输入持卡人姓名" type="text" maxlength="10" v-model="dataInfo.name" />
          </div>
          <div class="divider-padding-left"></div>
          <div class="info-input">
            <span>身份证号</span>
            <input disabled="disabled"  placeholder="请输入身份证号" type="text" maxlength="18" v-model="dataInfo.idCardNO"/>
          </div>
          <div class="divider-padding-left"></div>
          <div class="info-input">
            <span>银行卡号</span>
      ...
      getIdentityInfoX(){
        ...
        this.$http.get(`${window.Host.apiHost}/pos/identity`).then((res) => {
          ...
          if (res.body.data) {
            ...
            this.dataInfo.name = decRsa(info.realName);
            this.dataInfo.idCardNO = decRsa(info.idCardNo);
          }
        })
      },
